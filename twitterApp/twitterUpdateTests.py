...
class TwitterUpdateTestCase(unittest.TestCase):
    ...
    def test_welcome(self):
        rv = self.app.get('/')
        self.assertTrue('<h1>Welcome to the Twitter User Search Page!</h1>' in rv.data)
    ...
    def test_results_five(self):
        ...
        self.assertTrue('Search fields are empty' in rv.data)

    def test_redirect_home(self):
        rv = self.app.get('/')
        self.assertTrue('<a href="/">Home</a>' in rv.data)
        self.assertTrue('<a href="/display">Twitter Users on File</a>' in rv.data)
    ...
    def test_database_insert(self):
        ...
        try: # make sure that the twitterData mock database does not
            ...
            self.assertTrue(type(result) == dict, msg="Expected a result but none was found")
